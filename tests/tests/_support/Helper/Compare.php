...
class Compare extends \Codeception\Module
{
    ...
    {
        $height = $I->executeJS('var body = document.body,
                      html = document.documentElement;
    		          var height = Math.max( window.innerHeight, window.outerHeight, body.scrollHeight, body.offsetHeight, html.clientHeight, html.scrollHeight, html.offsetHeight )+150;
                      return height');
        return $height;
    }
